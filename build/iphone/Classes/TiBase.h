...
// in simulator we redefine to format for CoTM Developer console
...
{\
	NSString * exceptionName = [@"org.cotm." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cotm";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICoTMNativeItemNone = -1, 
	UICoTMNativeItemSpinner = -2,
	UICoTMNativeItemProgressBar = -3,
	
	UICoTMNativeItemSlider = -4,
	UICoTMNativeItemSwitch = -5,
	UICoTMNativeItemMultiButton = -6,
	UICoTMNativeItemSegmented = -7,
	
	UICoTMNativeItemTextView = -8,
	UICoTMNativeItemTextField = -9,
	UICoTMNativeItemSearchBar = -10,
	
	UICoTMNativeItemPicker = -11,
	UICoTMNativeItemDatePicker = -12,
	
	UICoTMNativeItemInfoLight = -13,
	UICoTMNativeItemInfoDark = -14,
	
	UICoTMNativeItemDisclosure = -15,
	
	UICoTMNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CoTM instances of
